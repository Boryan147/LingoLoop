          ...
          {phase === 'ACTIVE' && currentActiveItem && (
            <>
              <div className="flex-1 relative perspective-1000 min-h-[50vh] md:min-h-[350px] mb-6">
                <div 
                  className={`relative w-full h-full transition-transform duration-300 ease-out transform-style-3d will-change-transform grid grid-cols-1 grid-rows-1 ${isActiveFlipped ? 'rotate-y-180' : ''}`}
                ...
                >
                  ...
                  <div className={`col-start-1 row-start-1 w-full h-full bg-white rounded-3xl shadow-xl border border-slate-200/80 flex flex-col p-6 md:p-10 backface-hidden cursor-pointer hover:shadow-2xl transition-all overflow-y-auto custom-scrollbar ${isActiveFlipped ? 'pointer-events-none' : 'z-20'}`}>
                    <div className="flex-1 flex flex-col items-center justify-center text-center">
                      ...
                      <button className="mt-8 text-xs font-bold text-indigo-650 px-4 py-2 bg-indigo-50 hover:bg-indigo-100 rounded-xl active:scale-95 transition-all">Reveal Answer</button>
                    </div>
                  </div>
                      ...
                      <div className="mt-4 pt-4 border-t border-white/20 border-dashed">
                        ...
                        <div className="flex gap-2 items-start">
                          ...
                          <button
                            ...
                            className="px-4 py-2 bg-white text-emerald-700 active:scale-95 rounded-xl font-bold text-xs hover:bg-emerald-50 disabled:opacity-50 transition-all shadow-md shrink-0 flex items-center justify-center h-14 cursor-pointer"
                          >
        ...
        <div className="fixed inset-0 bg-slate-900/60 backdrop-blur-sm flex items-center justify-center p-4 z-50 animate-in fade-in duration-200">
          <div className="bg-white rounded-3xl shadow-2xl border border-slate-100 max-w-lg w-full max-h-[90vh] overflow-y-auto p-6 space-y-4 animate-in zoom-in-95 duration-200 custom-scrollbar text-slate-800">
            ...
            <form onSubmit={handleModalSave} className="space-y-4 text-left">
                ...
                <div className="sm:col-span-2">
                  ...
                  <div className="flex gap-2">
                    <input
                      ...
                      className="flex-1 text-sm p-2.5 bg-slate-50 border border-slate-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-indigo-500 transition-all text-slate-900 font-medium"
                      required
                    />
                    <button
                      type="button"
                      ...
                      className="px-3.5 py-2.5 bg-indigo-600 hover:bg-indigo-700 active:scale-95 text-white font-bold rounded-xl text-xs flex items-center justify-center gap-1.5 disabled:opacity-50 transition-all duration-150 shadow-md shrink-0 cursor-pointer select-none"
                    >
                      {isModalGenerating ? <Loader2 className="w-3.5 h-3.5 animate-spin" /> : <Sparkles className="w-3.5 h-3.5 text-yellow-300 fill-current" />}
                    ...
                    <div className="mt-2.5 p-2.5 bg-emerald-50/90 border border-emerald-200/90 rounded-xl text-xs space-y-1.5 animate-in fade-in duration-200">
                      ...
                      <div className="flex flex-wrap gap-1.5 pt-0.5">
                        <button
                          ...
                          className={`px-2.5 py-1 rounded-lg text-xs font-medium active:scale-95 transition-all flex items-center gap-1 text-left border cursor-pointer ${
                ...
                <div>
                  ...
                  <div className="flex bg-slate-100 p-0.5 rounded-lg">
                    <button
                      ...
                      className={`flex-1 py-1 rounded-md text-[10px] font-bold active:scale-95 transition-all cursor-pointer ${modalType === 'ACTIVE' ? 'bg-white text-emerald-600 shadow-sm' : 'text-slate-450 hover:text-slate-600'}`}
                    >
                      Active
                    </button>
                    <button
                      ...
                      className={`flex-1 py-1 rounded-md text-[10px] font-bold active:scale-95 transition-all cursor-pointer ${modalType === 'PASSIVE' ? 'bg-white text-blue-600 shadow-sm' : 'text-slate-450 hover:text-slate-600'}`}
                    >
                      Passive
                    </button>
                  </div>
              ...
              {/* Definition */}
              <div>
                <label className="block text-[10px] font-bold text-slate-500 uppercase tracking-wide mb-1">Definition / Nuance</label>
                <textarea
              ...
              <div className="flex gap-3 pt-2">
                <button
                  ...
                  className="flex-1 py-3 bg-indigo-600 hover:bg-indigo-700 active:scale-[0.98] text-white font-bold rounded-xl disabled:opacity-50 transition-all duration-150 flex items-center justify-center gap-2 cursor-pointer shadow-md text-xs"
                >
                ...
                <button
                  type="button"
                  onClick={() => setIsCaptureModalOpen(false)}
                  className="px-6 py-3 bg-slate-100 hover:bg-slate-200 active:scale-[0.98] text-slate-700 font-bold rounded-xl transition-all duration-150 text-xs cursor-pointer"
                >
                  Cancel
                </button>
              </div>
